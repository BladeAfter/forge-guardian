...
grant all on public.game_players, public.player_heroes, public.hero_catalog, public.boss_combats, public.hero_combat_state, public.boss_reward_transactions to service_role;
